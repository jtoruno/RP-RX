...
class Commerce(val commerceId: String,val name: String,val posterImage: String/*,val promotions: List<Promotion>*/,val website: String,val facebook: String,val whatsapp: String,val instagram: String,val category: String?,val stores: List<Store>, val restrictions : String,val waysToUse : String, val description: String, val offer : Offer?) : Serializable
